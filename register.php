...
<div class="row">
  ...
  <div class="main" style="padding:10px; height:auto; width:100%; font-size:12px">
...
<br><br>
        ...
        <br><br>
                ...
                <br><br>
                  <button type="submit" name="register" class="osx">Register</button>
              
            </form>
  </div>
  <p style="color:#888; font-size:12px; font-weight:500"><a href="index.php">Login</a></p>
  </div>
