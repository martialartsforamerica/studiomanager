...
<div class="row">
  ...
  <p style="font-weight:500px; font-family: 'Arial, Tahoma, Helvetica, Verdana', sans-serif;">Curriculum Manager - Add Program</p>
 <div class="main" style="width:600px">	
  <form action="submit_program.php" style="font-size:12px" method="post">
			<br>
			...
			<input type="text" name="program_price" id="program_price">
		
<br><br>
			<input type="submit" class="osx" name="submit" value="Add entry" title="Add Entry">
		</form>
</div>
  </div>
