...
<div class="row">
  ...
  <p style="font-weight:500px; font-family: 'Arial, Tahoma, Helvetica, Verdana', sans-serif;">Curriculum Manager - Add Rank</p>
 <div class="main" style="width:600px">	
 <br>
  <form action="process_rank.php" style="font-size:12px" method="POST">
<label for="beltname">Belt Name: </label>
<input type="text" id="beltname" name="beltname" required>
<br><br>
<label for="program">Program: </label>
  <input type="text" id="program" name="program" required>
  <br><br><br>
  <label for="requirements">Requirements: </label><br><br>
  <textarea id="requirements" name="requirements" rows="6" cols="45" required>
</textarea>
  <br><br>
  <input type="submit" value="Add entry" title="Add entry" class="osx">
</form>
