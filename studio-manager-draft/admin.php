...
<div class="row">
  ...
  <div class="main" style="height:310px; width:100%">
    <br>
    <a href="setup-admin.php" style="font-size:12px">Setup</a>
    <br>
    <br>
    <a href="accounts-admin.php" style="font-size:12px">Accounts</a>
    <br>
    <br>
    <a href="my-profile-admin.php" style="font-size:12px">My Profile</a>
    <br>
    <br>
    <a href="incident-reports-admin.php" style="font-size:12px">Incident Reports</a>
    <br>
    <br>
    <a href="logs-admin.php" style="font-size:12px">Logs</a>
    <br>
    <br>
    <a href="attendance-admin.php" style="font-size:12px">Attendance</a>
    <br>
    <br>
    <a href="studio-manager-data-admin.php" style="font-size:12px">Studio Manager Data</a>
    <br>
    <br>
    <a href="settings-admin.php" style="font-size:12px">Settings</a>
    <br>
    <br>
    <a href="events-admin.php" style="font-size:12px">Events</a>
    <br>
    <br>
  </div>
  </div>
