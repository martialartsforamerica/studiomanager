...
<div class="row">
  ...
  <p style="font-weight:500px; margin-right:-50px; margin-left:-20px; margin-bottom:5px; font-family: 'Arial, Tahoma, Helvetica, Verdana', sans-serif;">Curriculum Manager - Techniques</p>
 <div class="main" style="width:660px; height:400px">	
<?php
$user = 'root';
$password = '';
$database = 'curriculum';
...
$sql = " SELECT * FROM techniques ORDER BY categoryname ASC ";
...
<body>
    ...
    <div class="scrollit">
		<table>
			...
			?>
			<tr>
				<td><?php echo $rows['techniquename'];?></td>
